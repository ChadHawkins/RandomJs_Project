...
function populateProducts(productList) {
  ...
  //run loop through products and create HTML element ('product-item') for each of them
  ...
  productList.forEach(function (product, index) {
    ...
    //create the product title, author, pricetitle and price
